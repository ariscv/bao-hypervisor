...
#define HEDELEG_IAM                 (1UL << 0)
#define HEDELEG_IAF                 (1UL << 1)
#define HEDELEG_ILI                 (1UL << 2)
#define HEDELEG_BKP                 (1UL << 3)
#define HEDELEG_LAM                 (1UL << 4)
#define HEDELEG_LAF                 (1UL << 5)
#define HEDELEG_SAM                 (1UL << 6)
#define HEDELEG_SAF                 (1UL << 7)
#define HEDELEG_ECU                 (1UL << 8)
#define HEDELEG_ECS                 (1UL << 9)
#define HEDELEG_ECV                 (1UL << 10)
#define HEDELEG_IPF                 (1UL << 12)
#define HEDELEG_LPF                 (1UL << 13)
#define HEDELEG_SPF                 (1UL << 15)
...
#define HCOUNTEREN_CY               (1UL << 0)
#define HCOUNTEREN_TM               (1UL << 1)
#define HCOUNTEREN_IR               (1UL << 2)
